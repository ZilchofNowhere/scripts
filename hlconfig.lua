...
-- command bar carried over the statusline
local SearchCount = {
    condition = function()
...
local DefaultStatusline = {
    ...
    Align,
    Space, SearchCount, Space, MacroRec, Space, FileType, Space, Ruler, Space, ScrollBar, Space, FileSize, Space, FileEncoding, Space, FileFormat, Space }
